...
from FuzzyModel.model import FuzzyLayer
...
train_dataset=MyDataset(start_index=1001,end_index=1500)
...
test_dataset=MyDataset(start_index=1501,end_index=1995)
...
for epoch in range(epoch_num):
    ...
    if epoch % 1 == 0:
        ...
        for test_batch in test_loader:
            ...
            loss = F.mse_loss(test_preds, test_gts)
